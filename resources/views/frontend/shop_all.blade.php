...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid py-3" style="background-color:antiquewhite;">
        <p class="p"><a href="{{ route('frontend.index') }}" style="text-decoration: none; color:black;">Home</a>>All Products</p>
    </div>
    ...
    <div class="col-md-9">
        ...
        <div class="row text-center g-4">
            ...
            <div class="col-md-4">
                <div class="card-border-0">
                    <div class="position-relative">
                       <img src="https://tse4.mm.bing.net/th/id/OIP.ysFD0-pAp_PV4qnuakJFoQHaIX?pid=Api&P=0&h=180"  style="height: 300px;" class="card-img-top" alt="">
                        <!-- <div class="position-absolute bottom-0 start-50 translate-middle-x mb-3">
                        <button class="btn btn-dark rounded-pill px-4">
                            Add to Cart
                        </button>
        ...
        <div class="row text-center g-4">
            <div class="col-md-4">
                <div class="card-border-0">
                    <div class="position-relative">
                        <img src="https://tse4.mm.bing.net/th/id/OIP.E2TqeaFepgmcVV6DQ2B01gHaKb?pid=Api&P=0&h=180" style="height: 300px;"  class="card-img-top" alt="">
                        <!-- <div class="position-absolute bottom-0 start-50 translate-middle-x mb-3">
                        <button class="btn btn-dark rounded-pill px-4">
                            Add to Cart
                        </button>
            ...
            <div class="col-md-4">
                <div class="card-border-0">
                    <div class="position-relative">
                        <img src="https://static.wixstatic.com/media/ea71bb_a48625ef802d4bdcb90f1f9e672117ef~mv2_d_2479_2483_s_4_2.jpg/v1/fill/w_497,h_498,al_c,q_85,usm_0.66_1.00_0.01/ea71bb_a48625ef802d4bdcb90f1f9e672117ef~mv2_d_2479_2483_s_4_2.jpg" style="height: 300px;"   class="card-img-top" alt="">
                        <!-- <div class="position-absolute bottom-0 start-50 translate-middle-x mb-3">
                        <button class="btn btn-dark rounded-pill px-4">
                            Add to Cart
                        </button>
