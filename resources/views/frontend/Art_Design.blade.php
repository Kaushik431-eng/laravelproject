...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid py-3" style="background-color:antiquewhite;">
        <p class="p"><a href="{{ route('frontend.index') }}" style="text-decoration: none; color:black;">Home</a> >art & Design</p>
    </div>
            ...
            <div class="col-md-4">
                <div class="card-border-0">
                    <div class="position-relative">
                     ...
                     <div class="card-body">
                        <h5 class="card-title"> Travelling With Youre Vegeterian Child</h5>
                        <p class="">$27.00</p>
                     </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card-border-0">
                    <div class="position-relative">
                     ...
                     <div class="card-body">
                        <h5 class="card-title"> Interiar Design</h5>
                        <p class=""> $22.00</p>
                     </div>
                </div>
            </div>
